                        ...
                        <div class="tab-pane fade border p-3" id="details-tab-pane" role="tabpanel" aria-labelledby="details-tab" tabindex="0">
                            <div class="row">
                                <div class="col-md-4 mb-4">
                                    ...
                                    <input type="text" step="0.00" class="form-control" name="original_price" value="{{ $product->original_price }}" />
                                ...
                                <div class="col-md-4 mb-4">
                                    ...
                                    <input type="text" step="0.00" class="form-control" name="selling_price" value="{{ $product->selling_price }}" />
                                    @error('selling_price')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-3 mb-4">
                                    <div>
                                        ...
                                        <input type="text" step="0.0000" class="form-control" name="quantity" value="{{ $product->quantity }}" />
                                        @error('quantity')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-3 mb-4 form-group">
                                    ...
                                    <select  style="height:45px;" class="form-control" name="quantity_unit">
                                        ...
                                        <option value="pcs" {{ $product->quantity_unit == 'pcs' ? 'selected' : '' }}>Pieces (pcs)</option>
                                        <option value="kg" {{ $product->quantity_unit == 'kg' ? 'selected' : '' }}>Kilograms (kg)</option>
                                        <option value="g" {{ $product->quantity_unit == 'g' ? 'selected' : '' }}>Grams (g)</option>
                                        <option value="m" {{ $product->quantity_unit == 'm' ? 'selected' : '' }}>Meters (m)</option>
                                        <option value="cm" {{ $product->quantity_unit == 'cm' ? 'selected' : '' }}>Centimeters (cm)</option>
                                        <option value="mm" {{ $product->quantity_unit == 'mm' ? 'selected' : '' }}>Millimeters (mm)</option>
                                ...
                                <div class="col-md-3 mb-4">
                                    <div>
                                        ...
                                        <input type="text" step="0.0000" class="form-control" name="gross_weight" value="{{ $product->gross_weight }}" />
                                        @error('gross_weight')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-3 mb-4">
                                    <div>
                                        ...
                                        <input type="text" step="0.0000" class="form-control" name="net_weight" value="{{ $product->net_weight }}" />
                                        @error('net_weight')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-3 mb-4">
                                    <div>
                                        ...
                                        <select style="height:45px;" class="form-control" name="packaging_type">
                                            <option value="">Select an option</option>
                                            <option value="tube" {{ $product->packaging_type == 'tube' ? 'selected' : '' }}>Tube</option>
                                            <option value="box" {{ $product->packaging_type == 'box' ? 'selected' : '' }}>Box</option>
                                        </select>
                                ...
                                <div class="col-md-3 mb-4">
                                    <div>
                                        ...
                                        <input type="text" step="0.00" class="form-control" name="height" value="{{ $product->height }}" />
                                        @error('height')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-3 mb-4">
                                    <div>
                                        ...
                                        <input type="text" step="0.00" class="form-control" name="width_or_diameter" value="{{ $product->width_or_diameter }}" />
                                ...
                                <div class="col-md-3 mb-4">
                                    <div>
                                        ...
                                        <input type="text" step="0.00" class="form-control" name="length" value="{{ $product->length }}" />
                                        @error('length')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-4">
                                    <div class="bg-light p-3 border border-secondary">
                                        ...
                                        <input type="radio" name="featured" value="0" {{ $product->featured == '0' ? 'checked' : '' }} /> No Featured
                                        &nbsp;&nbsp;
                                        <input type="radio" name="featured" value="1" {{ $product->featured == '1' ? 'checked' : '' }} /> Featured
                                    </div>
                                </div>
                                <div class="col-md-4 mb-4">
                                    <div class="bg-light p-3 border border-secondary">
